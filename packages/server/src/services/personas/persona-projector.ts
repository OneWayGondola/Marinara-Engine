...
export function projectPersona(row: PersonaStorageRow): Persona {
  ...
  return {
    ...
    entitySummary: stringValue(row.entitySummary),
    entitySummaryGeneratedAt: typeof row.entitySummaryGeneratedAt === "string" ? row.entitySummaryGeneratedAt : null,
    entitySummarySource:
      row.entitySummarySource === "ai" || row.entitySummarySource === "manual" ? row.entitySummarySource : null,
    entitySummaryContentHash: typeof row.entitySummaryContentHash === "string" ? row.entitySummaryContentHash : null,
    entitySummaryProjectionVersion:
      typeof row.entitySummaryProjectionVersion === "number" ? row.entitySummaryProjectionVersion : null,
